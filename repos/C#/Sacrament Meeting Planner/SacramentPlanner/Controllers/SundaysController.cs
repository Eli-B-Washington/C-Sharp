...
namespace SacramentPlanner.Controllers
{
    public class SundaysController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Date,Conductor,OpeningHymn,ClosingHymn,SacramentHymn,IntermediateSong,OpeningPrayer,ClosingPrayer,Theme,Speakers")] SpeakerSunday sunday)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var speakerSunday = sunday;

            if (speakerSunday == null)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                _context.Add(speakerSunday);
                await _context.SaveChangesAsync();
                return RedirectToAction(nameof(Index));
            }
            return View(speakerSunday);
        }
